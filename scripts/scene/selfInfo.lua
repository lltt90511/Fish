...
function create(parent)
    ...
    widget.nameEdit.text.obj:setVisible(false)
    initEditBox()
    -- widget.panel.bg.vipBar.obj:setVisible(false)
    -- widget.panel.bg.Image_18.obj:setVisible(false)
    -- widget.panel.bg.vipNum.obj:setVisible(false)
    -- widget.panel.bg.Image_39.obj:setVisible(false)
    -- widget.panel.bg.vipLv.obj:setVisible(false)
